Partial Class CopySamplesSummary
...
#Region "Grid Related"
    ...
    Private Sub InitialiseSummaryGrid()
        ...
        Catch ex As Exception
            clsAppError.DisplayError("Error initialising the Summary Grid, CopySamplesSummary page.", ex)
        End Try
    End Sub
...
#Region "Event Handlers"
    ...
    Private Sub grdBatchSummary_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataGridItemEventArgs) Handles grdBatchSummary.ItemDataBound
        ...
        Catch ex As Exception
            clsAppError.DisplayError("Failed to bind template columns in the CopySamplesSummary grid", ex)
        End Try
    End Sub
