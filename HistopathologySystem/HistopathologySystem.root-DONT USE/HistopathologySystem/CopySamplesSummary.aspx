...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="CopySamplesSummary.aspx.vb" Inherits="HistopathologySystem.CopySamplesSummary"%>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>CopySamplesSummary</title>
	...
	<body>
		<FORM id="Form1" method="post" runat="server">
			...
			<DIV style="WIDTH: 734px; POSITION: relative; HEIGHT: 88px" ms_positioning="GridLayout">
				...
				<DIV id="ctlDivGrid" style="Z-INDEX: 102; LEFT: 8px; WIDTH: 682px; POSITION: absolute; TOP: 56px; HEIGHT: 7px"
				...
				<HR style="Z-INDEX: 104; LEFT: 8px; POSITION: absolute; TOP: 80px; HEIGHT: 1px" width="96.68%"
					SIZE="1">
			</DIV>
			...
			<DIV style="WIDTH: 743px; POSITION: relative; HEIGHT: 54px" ms_positioning="GridLayout">
				<asp:button id="btnCancel" style="Z-INDEX: 104; LEFT: 616px; POSITION: absolute; TOP: 17px"
					runat="server" Text="Done" Width="113" Height="24px"></asp:button>
