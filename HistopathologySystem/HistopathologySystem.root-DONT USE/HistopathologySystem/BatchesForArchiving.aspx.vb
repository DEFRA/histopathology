Partial Class BatchesForArchiving
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        VLAHeader1.PageTitle = "Archive Submissions"
        CheckPermissions()
...
#Region "Grid Handling"
    ...
    Private Sub InitialiseBatchesGrid()
        Try
            ...
            If Not objBatch.GetBatchesWithStatus(dtBatches, HistopathologyLib.clsBatch.STATUS_COMPLETED) Then
                Throw New Exception("Batch.GetBatchesWithStatus returned false.")
            End If

            Session(SessionVars.SV_BatchesForArchivingTable) = dtBatches
            ...
            Session(SessionVars.SV_BatchesForArchivingView) = dvBatchesView
            ...
            BatchesPager.DataTableSessionID = SessionVars.SV_BatchesForArchivingTable
            BatchesPager.DataViewSessionID = SessionVars.SV_BatchesForArchivingView
...
#Region "Event Handlers"
    ...
    Private Sub grdBatchesForDispatch_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles grdBatchesForDispatch.SelectedIndexChanged
        If grdBatchesForDispatch.SelectedIndex >= 0 Then
            ...
            Session.Item(SessionVars.SV_RedirectPage) = "BatchesForArchiving.aspx"
            Session.Item(SessionVars.SV_RedirectCancelPage) = "BatchesForArchiving.aspx"
        ...
        Try
            If ValidateMandatoryFields() Then
                ...
                If Not objBatch.CheckBatchExists(iBatchID, _
                                                HistopathologyLib.clsBatch.STATUS_COMPLETED, _
                                                iCount, _
                                                iBatchType, _
                                                iCassetted) Then
