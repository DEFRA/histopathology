...
Public Class HistologySubReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HistopathologySystem.HistologySubReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedHistologySubReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As HistologySubReport = New HistologySubReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
