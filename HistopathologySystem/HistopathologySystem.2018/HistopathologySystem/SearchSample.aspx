...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="SearchSample.aspx.vb" Inherits="HistopathologySystem.SearchSample" %>
...
<HTML>
	...
	<body>
		<form id="Form1" method="post" runat="server">
			...
			<DIV style="WIDTH: 640px; POSITION: relative; HEIGHT: 98px" ms_positioning="GridLayout">
				<HR style="Z-INDEX: 101; LEFT: 8px; WIDTH: 98.4%; POSITION: absolute; TOP: 94px; HEIGHT: 1px"
					width="98.4%" SIZE="1">
				...
				<asp:Label id="lblExplain" style="Z-INDEX: 104; LEFT: 16px; POSITION: absolute; TOP: 50px"
			...
			<DIV style="WIDTH: 445px"><asp:datagrid id="grdSenders" runat="server" AutoGenerateColumns="False" PageSize="100" AllowPaging="True">
			...
			<DIV id="ctlDiv" style="WIDTH: 640px; HEIGHT: 8px" runat="Server" ms_positioning="FlowLayout"></DIV>
