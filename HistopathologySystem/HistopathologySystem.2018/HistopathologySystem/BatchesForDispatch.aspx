<%@ Page Language="vb" AutoEventWireup="false" Codebehind="BatchesForDispatch.aspx.vb" Inherits="HistopathologySystem.BatchesForDispatch" smartNavigation="True"%>
		...
		<form id="Form1" method="post" runat="server">
			...
			<DIV style="WIDTH: 741px; POSITION: relative; HEIGHT: 32px" ms_positioning="GridLayout">
				<asp:label id="lblBatches" style="Z-INDEX: 101; LEFT: 10px; POSITION: absolute; TOP: 8px" runat="server"
					Font-Bold="True"> Submissions awaiting Quality Data</asp:label></DIV>
