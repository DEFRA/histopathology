...
public interface ILookupService
{
    ...
    /// <summary>Returns contacts for the given area. Maps to <c>GetContactsArea</c>.</summary>
    Task<IReadOnlyList<LookupItem>> GetContactsByAreaAsync(string area, CancellationToken ct = default);

    /// <summary>Returns projects for the given area. Maps to <c>GetProjectsArea</c>.</summary>
